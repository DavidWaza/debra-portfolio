...
const Hero = () => {
  return (
    <div className="relative h-full lg:h-[60rem] xl:h-screen w-full bg-black overflow-hidden py-10 md:py-0">
      <motion.div
      ...
      <motion.div
        ...
        className="absolute top-10 left-16 text-gray-300 text-sm tracking-widest hidden md:block"
      >
        [ WHERE BEYOND ]
      </motion.div>
      ...
      <motion.div
        ...
        className="absolute top-10 left-1/2 -translate-x-1/2 text-gray-300 text-sm tracking-widest  hidden md:block" 
      >
        PRODUCT DESIGN
      </motion.div>
      ...
      <motion.div
        ...
        className="absolute top-10 right-16 text-gray-300 text-sm tracking-widest  hidden md:block"
      >
        [ BREAK THE NORM ]
      </motion.div>
      ...
      <div className="relative h-full max-w-420 mx-auto px-10 flex items-center">
        ...
        >
          <motion.h1
            ...
            className="uppercase font-extrabold leading-[0.95]"
          >
            {["Innovate", "For Design", "& execute"].map((line, index) => (
              <motion.span
                ...
                className={`block text-4xl lg:text-6xl  xl:text-8xl ${
